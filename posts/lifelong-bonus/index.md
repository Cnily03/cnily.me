...
{{< admonition tip >}}
相关附件（仅限教学或个人学习使用）
{{< link content="<i class='fas fa-link'></i> PPT" href="https://cdn.cnily.top/public/doc/Lifelong%20Bonus.pptx" class="float-right color-only" >}}
<span tyle="width:.5em;" class="float-right color-only">&nbsp;</span>
{{< link content="<i class='fas fa-link'></i> 文档" href="https://cdn.cnily.top/public/doc/Lifelong%20Bonus.docx" class="float-right color-only" >}}
{{< /admonition >}}
